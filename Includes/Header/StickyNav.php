...
<div id='stickyNavbar' class='MasterContainer stickyMenu hidesticky'>
    <nav id='navbar' class='navbar  w-100'>
        ...
        <a href='#/' id='stickyHAMBURGER' class='toggle-button mt-2'>
            <span class='bar'></span>
            <span class='bar'></span>
            <span class='bar'></span>
        </a>
        <div id='stickyNAV-LINKS' class='navbar-links'>
            <ul>
                ...
                <?php if (isset($_SESSION['Connected-UserID'])):
                    ...
                    <li id='dropContainerID' class='d-flex vlhrparent'>
                        ...
                        <div class='Adiv d-flex flex-column dropdown show'>
                            <a href='#/' id='dropToggleID' class='dropdown-toggleCustom' role='button' ><img style='width:27px; height: 27px; object-fit: cover;' class='rounded-circle bg-white navpfp' src='<?php echo "uploads/" . $_SESSION["Connected-UserPfp"];?>'>
