...
?>
<div class="modal fade h-100 reportModal confirm_delete" id="confirm-delete" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
<div class="modal-dialog d-flex justify-content-center align-items-center h-100">
            <div class="card modal-content">
                <div class="card-header modal-header border-danger">
                    <h2 class="modal-title font-weight-bold mx-auto">Manage Report</h2>
