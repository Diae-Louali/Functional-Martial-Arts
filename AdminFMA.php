...
$query = "SELECT * FROM comments_and_replies AS c JOIN user AS u ON c.user_ID=u.Id 
          WHERE c.comment_status = ? ORDER BY comment_id DESC ";
...
if (isset($_POST['add-post-btn'])) {
    ...
    if (empty($ImgErrorMsg) && (is_array($existingPost) < 1)) {
        ...
        // echo $_SESSION['Added'] . "<br>" . $_SESSION['Message'];
    }
}
...
if (isset($_POST['edit-user-button'])) {
    ...
    if ((is_array($existingEmail) < 1) || ((is_array($existingEmail) > 0) && ($existingEmail['Id'] === $_POST['Id']))){
        ...
        // echo $_SESSION['Edited'] . "<br>" . $_SESSION['Message'];
        }
...
<body>
    ...
    <!-- Report Modal -->
    <?php include("Includes\Modal\Modal-report.php");?>
    ...
    <div class="container mx-md-0 mw-100 px-0 h-100">
        ...
        <div class="row h-100">
            ...
            <div class="admin-nav-wrapper col-xl-2 col-lg-3 px-0 h-100">
                <div class="admin-nav-container h-100">
                    <div class="nav flex-column nav-pills py-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                        ...
                        <a class="nav-link w-100 rounded-0" id="v-pills-Manage-Reports-tab" data-toggle="pill" href="#v-pills-Manage-Reports" role="tab" aria-controls="v-pills-Manage-Reports" aria-selected="true"><i class="fa fa-exclamation-circle" aria-hidden="true"></i> Manage Reports</a>
            ...
            <div class="admin-content col-xl-10 col-lg-9 tab-content p-0" id="v-pills-tabContent">
                ...
                <div class="tab-pane fade show p-5" id="v-pills-Manage-Reports" role="tabpanel" aria-labelledby="v-pills-Manage-Reports-tab">                                    
                    
                    <div class="button-group">
                        <a href="#/" class="btn Post-Manage-Btn General-btn">Manage Articles</a>
                    </div>
                    <h2 class="page-title">Reported Comments</h2>
                        ...
                        <table>
                            ...
                            <?php foreach ($comments as $key => $comment) { ?>
                                <tr>
                                    ...
                                    <td><a href="ArticleFMA.php?id=<?php echo $comment['article_ID'];?>&comment_Id=<?php echo $comment['comment_ID'];?>" class="publish-post manage-links">Open</a></td>
                                    <td><a href="#/" class="delete-post manage-links" data-href="<?php echo $comment['Username'] . '*' . $comment['comment_content'] . '*' . "delete-post";?>" data-toggle="modal" data-target=".reportModal">Delete</a></td>
                                </tr>
                            <?php } ?>
                        </table>
                    </div>                    
                ...
                <div class="tab-pane fade p-5" id="v-pills-add-post" role="tabpanel" aria-labelledby="v-pills-add-post-tab">                                    
                    ...
                    <?php if (isset($_SESSION['Message']) && ($added == 'post-add-fail' )) { 
                        echo $_SESSION['Message']; 
                        unset($_SESSION['Message']); 
                    }?> 
                ...
                <div class="tab-pane fade p-5" id="v-pills-add-Users" role="tabpanel" aria-labelledby="v-pills-add-Users-tab">                                                        
                    ...
                    <?php if (isset($_SESSION['Message']) && ($added == 'user-add-fail')) { 
                        echo $_SESSION['Message']; 
                        unset($_SESSION['Message']); 
                    }?> 
                        ...
                        <div class="d-inline-block profile-div-form mr-2">
                                <div class="d-flex">
                                    ...
                                    <div class="md-form input-with-pre-icon profile-input-forms mx-0">
                                        ...
                                        <label for="First-name2" class="pl-2">First name </label>
                                    </div>
                                </div>
                            </div>
                            <div class="d-inline-block profile-div-form">
                                <div class="d-flex">
                                    ...
                                    <div class="md-form input-with-pre-icon profile-input-forms mx-0">
                                        ...
                                        <label for="Last-name2" class="pl-2">Last name </label>
                                    </div>
                                </div>
                            </div>
                            <div class="d-inline-block profile-div-form mr-2">
                                <div class="d-flex">
                                    ...
                                    <div class="md-form input-with-pre-icon profile-input-forms mx-0">
                                        ...
                                        <label for="username2" class="pl-2">Username </label>
                                    </div>
                                </div>
                            </div>
                            <div class="d-inline-block profile-div-form mr-2">
                                <div class="d-flex">
                                    ...
                                    <div class="md-form input-with-pre-icon profile-input-forms mx-0">
                                        <i class="fas fa-lock input-prefix enableEdit"></i>  
                                        <input type='password' id="password2" name='Password' value="<?php echo $userEditPassword; ?>" class="form-control inputToDisable">
                            ...
                            <div class="d-flex profile-div-form w-50 float-left">
                                ...
                                <div class="md-form input-with-pre-icon w-100 profile-input-forms mx-0">
                                    ...
                                    <label for="Input-Email2" data-error="wrong" data-success="right" class="pl-2">Email</label>
                                </div>                        
                            </div> 
                            <div class="d-inline-block profile-div-form">
                                <div class="d-flex">
                                    ...
                                    <div class="md-form input-with-pre-icon profile-input-forms mx-0">
                                        ...
                                        <label for="Age2" class="pl-2">Age </label>
                                    </div>
                                </div>
                            </div>                    
                            <div class="d-flex profile-div-form w-50 float-right mt-4">                                
                                <div class="d-flex align-items-center justify-content-end font-weight-bolder finput-title enableEdit pr-3 w-0">Role :</div>
                                <select name="Role" class="md-form w-50 mx-0">
                                <?php if (isset($userEditRole) && ($userEditRole == 'Admin')) { ?> 
                                    <option value="" disabled>Choose Role</option>
                                    <option value="Admin" selected>Admin</option>
                                    <option value="Moderator">Moderator</option>
                                    <option value="User">User</option>                                    
                                <?php } elseif (isset($userEditRole) && ($userEditRole == 'Moderator')) { ?>
                                    <option value="" disabled>Choose Role</option>
                                    <option value="Admin">Admin</option>
                                    <option value="Moderator" selected>Moderator</option>
                                    <option value="User">User</option>                                    
                                <?php } elseif (isset($userEditRole) && ($userEditRole == 'User')) { ?>
                                    <option value="" disabled>Choose Role</option>
                                    <option value="Admin">Admin</option>
                                    <option value="Moderator">Moderator</option>
                            ...
                            <div class="d-flex profile-div-form w-50">
                                ...
                                <div class="md-form input-with-pre-icon w-100 profile-input-forms mx-0">
                                    ...
                                    <label for="Address2" class="pl-2">Address </label>
                                </div>
                            </div>
